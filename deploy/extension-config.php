 ...
 *
 * @param string $location Where to create the new archive
 * @param string $archiveName The filename to create
 * @param array $extensions The name of each extension dir
 * @return string
 */
...
return array(
	...
	'extension_name'         => 'eBay_Enterprise_Retail_Order_Management',
	...
	'summary'                => 'eBay Enterprise Retail Order Management',
	'description'            => 'eBay Enterprise Retail Order Management',
	'notes'                  => $releaseNotes,
