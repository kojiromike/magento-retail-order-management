	...
	implements EbayEnterprise_Eb2cCore_Helper_Interface
{
	...
	const LINES_PATH    = 'a:Line1|a:Line2|a:Line3|a:Line4';
	const CITY_PATH     = 'a:City';
	const REGION_PATH   = 'a:MainDivision';
	const COUNTRY_PATH  = 'a:CountryCode';
	const POSTCODE_PATH = 'a:PostalCode';
	...
	/**
	 * Generate the xml to represent the XSD PhysicalAddressType from an address
	 *
	...
	/**
	 * Create a valid address object from XSD PhysicalAddressType xml nodes
	 *
