...
class EbayEnterprise_Catalog_Helper_Feed extends Mage_Core_Helper_Abstract
{
    ...
    const GIFTCARD_TENDER_CONFIG_PATH = 'ebayenterprise_catalog/feed/gift_card_tender_code';
     ...
     * @return array
     *         Example: array(
     *             'ItemMaster' => 'ebayenterprise_catalog/feed/filetransfer_imports/item_master/outbound/message_header',
     *             'ImageMaster' => 'ebayenterprise_catalog/feed/filetransfer_exports/image_master/outbound/message_header',
     *             ...
     *         )
     */
