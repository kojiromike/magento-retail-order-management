...
class EbayEnterprise_Catalog_Helper_Map_Giftcard extends Mage_Core_Helper_Abstract
{
	...
	protected function _getGiftCardMap()
	{
		if (empty($this->_giftcardMap)) {
			$this->_giftcardMap = Mage::helper('ebayenterprise_catalog')
				->getConfigModel()
				->getConfigData(EbayEnterprise_Catalog_Helper_Feed::GIFTCARD_TENDER_CONFIG_PATH);
		}
