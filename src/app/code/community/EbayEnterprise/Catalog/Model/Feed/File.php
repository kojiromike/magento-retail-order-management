...
class EbayEnterprise_Catalog_Model_Feed_File
{
	 ...
	 * @return self
	 */
	public function process( EbayEnterprise_Catalog_Interface_Import_Config $config,
	...
	protected function _updateItem(
		...
		$storeId, array $cfgData, EbayEnterprise_Catalog_Interface_Import_Items $items
	)
	{
