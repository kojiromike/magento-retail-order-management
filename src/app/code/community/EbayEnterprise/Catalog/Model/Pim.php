...
class EbayEnterprise_Catalog_Model_Pim
{
     ...
     * @return EbayEnterprise_Catalog_Model_Pim_Product_Collection collection of PIM Product instances
     */
    protected function _createFeedDataSet()
    {
        ...
        /** @var EbayEnterprise_Catalog_Model_Pim_Product_Collection $pimProducts */
        $pimProducts = Mage::getModel('ebayenterprise_catalog/pim_product_collection');
    ...
    protected function _processProductCollection(
        ...
        EbayEnterprise_Catalog_Model_Pim_Product_Collection $pimProducts,
        ...
        foreach ($products->getItems() as $product) {
            ...
            if (!$pimProduct) {
                $pimProduct = Mage::getModel('ebayenterprise_catalog/pim_product', array(
            ...
            try {
                $pimProduct->loadPimAttributesByProduct(
                    ...
                    $this->_doc,
                    $this->_getFeedConfig(),
                    $this->_getFeedAttributes($currentStoreId)
                );
     ...
     * @param  EbayEnterprise_Catalog_Model_Pim_Product $pimProduct
     * @param string $childNode
     * @return DOMDocumentFragment
     */
    protected function _buildItemNode(EbayEnterprise_Catalog_Model_Pim_Product $pimProduct, $childNode)
    {
    ...
    protected function _appendAttributeValue(
        ...
        EbayEnterprise_Catalog_Model_Pim_Attribute $pimAttribute
    ) {
     ...
     * @return EbayEnterprise_Catalog_Model_Feed core feed model
     */
    protected function _setUpCoreFeed()
    {
        return Mage::getModel('ebayenterprise_catalog/feed_core', array(
            'feed_config' => Mage::helper('ebayenterprise_catalog')->getConfigModel()->pimExportFeed
        ));
    }
    /**
    ...
    protected function _startDocument()
    {
        ...
        $this->_doc->loadXML(sprintf(
            ...
            Mage::helper('ebayenterprise_catalog')->generateMessageHeader($config[self::KEY_EVENT_TYPE]),
