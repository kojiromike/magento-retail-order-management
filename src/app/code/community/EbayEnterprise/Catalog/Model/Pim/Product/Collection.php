...
class EbayEnterprise_Catalog_Model_Pim_Product_Collection extends Varien_Data_Collection
{
    ...
    public function getFirstItem()
    {
        if (empty($this->_items)) {
            throw new EbayEnterprise_Catalog_Model_Pim_Product_Collection_Exception(
