...
class EbayEnterprise_Catalog_Test_Helper_Map_GiftcardTest extends EbayEnterprise_Eb2cCore_Test_Base
{
    /**
    ...
    public function testGetGiftCardMap()
    {
        ...
        $configRegistryMock->expects($this->once())
            ...
            ->with($this->identicalTo(EbayEnterprise_Catalog_Helper_Feed::GIFTCARD_TENDER_CONFIG_PATH))
    ...
    public function testGetGiftCardType()
    {
        ...
        $testData = array(
            array(
                ...
                'type' => EbayEnterprise_Catalog_Helper_Map_Giftcard::GIFTCARD_VIRTUAL
            ),
            array(
                'expect' => Enterprise_GiftCard_Model_Giftcard::TYPE_PHYSICAL,
                'type' => EbayEnterprise_Catalog_Helper_Map_Giftcard::GIFTCARD_PHYSICAL
            ),
            array(
     ...
     * Expectation 1: when this test invoked the method EbayEnterprise_Catalog_Helper_Map_Giftcard::extractGiftcardTenderValue with
     ...
     *                and then the method EbayEnterprise_Catalog_Helper_Map_Giftcard::_getGiftCardType will be given the value
    ...
    public function testExtractGiftcardTenderValue()
    {
        ...
        $giftcardHelperMock = $this->getHelperMockBuilder('ebayenterprise_catalog/map_giftcard')
            ->disableOriginalConstructor()
     ...
     *      EbayEnterprise_Catalog_Helper_Map_Giftcard::extractGiftcardTenderTypeValue and expect
     ...
     * Expectation 1: when the EbayEnterprise_Catalog_Helper_Map_Giftcard::extractIsRedeemable method invoked
     *                with the given DOMNodeList it will call the EbayEnterprise_Catalog_Helper_Map_Giftcard::extractGiftcardTenderValue
     ...
     * Expectation 1: when the EbayEnterprise_Catalog_Helper_Map_Giftcard::extractLifetime method invoked
     *                with the given DOMNodeList it will call the EbayEnterprise_Catalog_Helper_Map_Giftcard::extractGiftcardTenderValue
     ...
     * Expectation 1: the method EbayEnterprise_Catalog_Helper_Map_Giftcard::extractEmailTemplate when invoked by this test
     *                will be given a DOMNodeList object and a Mage_Catalog_Model_Product object and with this
     *                given parameter it will call the EbayEnterprise_Catalog_Helper_Map_Giftcard::extractGiftcardTenderValue
     ...
     * Expectation 2: the method EbayEnterprise_Eb2cCore_Helper_Data::getStoreConfig will be invoked and given
     ...
     *      EbayEnterprise_Catalog_Helper_Map_Giftcard::extractGiftcardTenderValue return null
