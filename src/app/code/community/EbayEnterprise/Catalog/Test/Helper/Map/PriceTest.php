...
class EbayEnterprise_Catalog_Test_Helper_Map_Price extends EbayEnterprise_Eb2cCore_Test_Base
{
    public $price = 12.34;
    ...
    public function testExtractPrice()
    {
        $this->assertSame(
            $this->price,
            Mage::helper('ebayenterprise_catalog/map_price')->extractPrice($this->eventNodeList)
        );
    }
    /**
     * Test extracting a price from the `Event` node.
    ...
    public function testExtractSpecialPrice()
    {
        $this->assertSame(
            $this->specialPrice,
            Mage::helper('ebayenterprise_catalog/map_price')->extractSpecialPrice($this->eventNodeList)
        );
    }
    /**
     * Test extracting a price from the `Event` node.
    ...
    public function testExtractPriceEventFromDate()
    {
        $this->assertSame(
            $this->specialFrom,
            Mage::helper('ebayenterprise_catalog/map_price')->extractPriceEventFromDate($this->eventNodeList)
        );
    }
    /**
     * Test extracting a price from the `Event` node.
    ...
    public function testExtractPriceEventToDate()
    {
        $this->assertSame(
            $this->specialTo,
            Mage::helper('ebayenterprise_catalog/map_price')->extractPriceEventToDate($this->eventNodeList)
        );
    }
}
