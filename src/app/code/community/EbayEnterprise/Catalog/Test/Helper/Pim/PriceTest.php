...
class EbayEnterprise_Catalog_Test_Helper_Pim_PriceTest extends EbayEnterprise_Eb2cCore_Test_Base
{
    /**
     * Test EbayEnterprise_Catalog_Helper_Pim_Price::passPriceEventNumber method for the following expectations
     * Expectation 1: this test will invoked the method EbayEnterprise_Catalog_Helper_Pim_Price::passPriceEventNumber
     ...
     *                EbayEnterprise_Catalog_Helper_Pim_Price::_buildEventNumber given the mocked product object which
     *                will return a known value and then another called to the method
     *                EbayEnterprise_Catalog_Helper_Pim::createStringNode given the return value of the mocked method
     *                EbayEnterprise_Catalog_Helper_Pim_Price::_buildEventNumber and the mocked EbayEnterprise_Dom_Document
    ...
    public function testPassPriceEventNumber()
    {
        ...
        $this->replaceByMock('helper', 'ebayenterprise_catalog/pim', $pimHelperMock);

        $priceMock = $this->getHelperMockBuilder('ebayenterprise_catalog/pim_price')
            ->disableOriginalConstructor()
    ...
    /**
     * Test EbayEnterprise_Catalog_Helper_Pim_Price::passPrice method for the following expectations
     * Expectation 1: this test will invoked the method EbayEnterprise_Catalog_Helper_Pim_Price::passPrice
     *                given a string attribute value, a string attribute, a mocked Mage_Catalog_Model_Product object and
     *                a mocked EbayEnterprise_Dom_Document object and expects the following methods to be invoked
     *                Mage_Catalog_Model_Product::getSpecialPrice when the method
     *                EbayEnterprise_Catalog_Helper_Pim_Price::_hasSpecialPrice is invoked given the mocked
     ...
     *                EbayEnterprise_Catalog_Helper_Pim::createTextNode and the mocked EbayEnterprise_Dom_Document
    ...
    /**
     * Test EbayEnterprise_Catalog_Helper_Pim_Price::passMsrp method for the following expectations
     * Expectation 1: this test will invoked the method EbayEnterprise_Catalog_Helper_Pim_Price::passMsrp
     *                given a string attribute value, a string attribute, a mocked Mage_Catalog_Model_Product object and
     *                a mocked EbayEnterprise_Dom_Document object and expects the following methods to be invoked
     *                Mage_Catalog_Model_Product::getMsrp and return a known value which is then pass as first parameter
     *                to the method EbayEnterprise_Catalog_Helper_Pim::createTextNode and the mocked
    ...
    /**
     * Test EbayEnterprise_Catalog_Helper_Pim_Price::passAlternatePrice method for the following expectations
     * Expectation 1: this test will invoked the method EbayEnterprise_Catalog_Helper_Pim_Price::passAlternatePrice
     *                given a string attribute value, a string attribute, a mocked Mage_Catalog_Model_Product object and
     *                a mocked EbayEnterprise_Dom_Document object and expects the following methods to be invoked
     *                Mage_Catalog_Model_Product::getSpecialPrice when the method
     *                EbayEnterprise_Catalog_Helper_Pim_Price::_hasSpecialPrice is invoked given the mocked
    ...
    /**
     * Test EbayEnterprise_Catalog_Helper_Pim_Price::passPriceDateFrom method for the following expectations
     * Expectation 1: this test will invoked the method EbayEnterprise_Catalog_Helper_Pim_Price::passPriceDateFrom
     *                given a string attribute value, a string attribute, a mocked Mage_Catalog_Model_Product object and
     *                a mocked EbayEnterprise_Dom_Document object and expects the following methods to be invoked
    ...
    /**
     * Test EbayEnterprise_Catalog_Helper_Pim_Price::passPriceDateTo method for the following expectations
     * Expectation 1: this test will invoked the method EbayEnterprise_Catalog_Helper_Pim_Price::passPriceDateTo
     *                given a string attribute value, a string attribute, a mocked Mage_Catalog_Model_Product object and
     *                a mocked EbayEnterprise_Dom_Document object and expects the following methods to be invoked
    ...
    /**
     * Test EbayEnterprise_Catalog_Helper_Pim_Price::passPriceVatInclusive method for the following expectations
     * Expectation 1: this test will invoked the method EbayEnterprise_Catalog_Helper_Pim_Price::passPriceVatInclusive
     *                given a string attribute value, a string attribute, a mocked Mage_Catalog_Model_Product object and
     ...
     *                EbayEnterprise_Catalog_Helper_Pim::createTextNode and then the mocked EbayEnterprise_Dom_Document
    ...
    /**
     * Test EbayEnterprise_Catalog_Helper_Pim_Price::_getTimeStamp method for the following expectations
     * Expectation 1: when this test invoked the method EbayEnterprise_Catalog_Helper_Pim_Price::_getTimeStamp given
    ...
    /**
     * Test EbayEnterprise_Catalog_Helper_Pim_Price::_hasSpecialPrice method for the following expectations
     * Expectation 1: this test will invoked the method EbayEnterprise_Catalog_Helper_Pim_Price::_hasSpecialPrice
    ...
    /**
     * Test EbayEnterprise_Catalog_Helper_Pim_Price::_buildEventNumber method for the following expectations
     * Expectation 1: this test will invoked the method EbayEnterprise_Catalog_Helper_Pim_Price::_buildEventNumber
     *                given mocked Mage_Catalog_Model_Product object in which will called the method
     *                EbayEnterprise_Catalog_Helper_Pim_Price::_hasSpecialPrice given the mocked product object
     *                which will then return true, which will allow the method
     *                EbayEnterprise_Catalog_Helper_Pim_Price::_getTimeStamp to be called 2 time given the
