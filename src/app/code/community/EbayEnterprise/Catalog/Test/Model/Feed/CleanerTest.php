...
class EbayEnterprise_Catalog_Test_Model_Feed_CleanerTest extends EbayEnterprise_Eb2cCore_Test_Base
{
    ...
    public function testGetAffectedSkus()
    {
        ...
        $cleaner = $this->getModelMock(
            'ebayenterprise_catalog/feed_cleaner',
    ...
    public function testGetAllUnresolvedRelations($rawValue, $links)
    {
        ...
        $cleaner = Mage::getModel('ebayenterprise_catalog/feed_cleaner', array('products' => $this->_getProductCollectionStub()));
        $this->assertSame(
            $links,
            EcomDev_Utils_Reflection::invokeRestrictedMethod(
                $cleaner,
    ...
    public function testCleanProductWithConfigurableProduct()
    {
        ...
        $feedCleanerModelProductMock->expects($this->once())
            ...
            ->with($this->isInstanceOf('Mage_Catalog_Model_Product'))
            ->will($this->returnSelf());
        $this->replaceByMock('model', 'ebayenterprise_catalog/feed_cleaner', $feedCleanerModelProductMock);

        $this->assertInstanceOf(
            'EbayEnterprise_Catalog_Model_Feed_Cleaner',
            Mage::getModel('ebayenterprise_catalog/feed_cleaner')->cleanProduct($product)
        );
    }
    ...
    public function testLinkProducts()
    {
        ...
        $cleaner = Mage::getModel('ebayenterprise_catalog/feed_cleaner', array('products' => $productCollection));
    ...
    public function testAddUsedProducts()
    {
        ...
        $cleanerObject = Mage::getModel('ebayenterprise_catalog/feed_cleaner', array('products' => $productCollection));
