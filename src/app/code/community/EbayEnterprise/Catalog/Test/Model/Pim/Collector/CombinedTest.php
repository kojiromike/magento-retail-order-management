...
class EbayEnterprise_Catalog_Test_Model_Pim_Collector_CombinedTest extends EbayEnterprise_Eb2cCore_Test_Base
{
    ...
    public function testGatherAllAsOneBatch()
    {
        ...
        $collector = Mage::getModel('ebayenterprise_catalog/pim_collector_combined');
