 ...
 */
class EbayEnterprise_Eb2cAddress_Test_Model_Validation_RequestTest extends EcomDev_PHPUnit_Test_Case
{
	/**
	...
	/**
	 * Create a EbayEnterprise_Eb2cAddress_Model_Validation_Request to test against.
