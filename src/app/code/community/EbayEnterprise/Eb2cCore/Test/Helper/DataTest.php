...
class EbayEnterprise_Eb2cCore_Test_Helper_DataTest extends EbayEnterprise_Eb2cCore_Test_Base
{
	 ...
	 * Expectation 1: the method EbayEnterprise_Eb2cCore_Helper_Data::getFileTimeElapse will be invoked by this test
	 *                and given a sourceFile in which will be passed to the method EbayEnterprise_Eb2cCore_Helper_Data::loadFile
	 *                and then call the method getCTime which will return the time source file was created, this time will
	 *                then be passed to the method EbayEnterprise_Eb2cCore_Helper_Data::getNewDateTime which will return a date
