	...
	extends EbayEnterprise_Eb2cCore_Test_Base
{
	 ...
	 * Expectation 1: this test will invoked the method EbayEnterprise_Eb2cCore_Model_Feed_Export_Ack::_getConfigMapValue
	 *                giving it a key for EbayEnterprise_Eb2cCore_Model_Feed_Export_Ack::_configMap array
	...
	{
		$cfgKey = EbayEnterprise_Eb2cCore_Model_Feed_Export_Ack::CFG_EXPORT_ARCHIVE;
		$configMap = array(
		...
		$map = array(
			EbayEnterprise_Eb2cCore_Model_Feed_Export_Ack::CFG_EXPORT_ARCHIVE => $configMap['feedExportArchive'],
			EbayEnterprise_Eb2cCore_Model_Feed_Export_Ack::CFG_IMPORT_ARCHIVE => $configMap['feedImportArchive'],
			EbayEnterprise_Eb2cCore_Model_Feed_Export_Ack::CFG_EXPORT_OUTBOX => $configMap['feedOutboxDirectory'],
			EbayEnterprise_Eb2cCore_Model_Feed_Export_Ack::CFG_IMPORTED_ACK_DIR => $configMap['feedAckInbox'],
			EbayEnterprise_Eb2cCore_Model_Feed_Export_Ack::CFG_EXPORTED_FEED_DIR => $configMap['feedSentDirectory'],
			EbayEnterprise_Eb2cCore_Model_Feed_Export_Ack::CFG_WAIT_TIME_LIMIT => $configMap['ackResendTimeLimit'],
		);
	 ...
	 *                when invoked by this test will call the method EbayEnterprise_Eb2cCore_Model_Feed_Export_Ack::_getConfigMapValue
	...
	{
		$cfgKey = EbayEnterprise_Eb2cCore_Model_Feed_Export_Ack::CFG_EXPORTED_FEED_DIR;
	 ...
	 *                when invoked by this test will call the method EbayEnterprise_Eb2cCore_Model_Feed_Export_Ack::_listFilesByCfgKey
	 ...
	 *                call the EbayEnterprise_Eb2cCore_Model_Feed_Export_Ack::_extractAckExportedFile method given an acknowledgment
	...
	{
		$cfgKey = EbayEnterprise_Eb2cCore_Model_Feed_Export_Ack::CFG_IMPORTED_ACK_DIR;
	...
	/**
	 * Test EbayEnterprise_Eb2cCore_Model_Feed_Export_Ack::_extractExportedFile method for the following expectations
	 * Expectation 1: the test will invoke the method EbayEnterprise_Eb2cCore_Model_Feed_Export_Ack::_extractExportedFile
	 *                given an acknowledgment file in which it will invoked the metheo
	 *                EbayEnterprise_Eb2cCore_Model_Feed_Export_Ack::_buildPath pass the cfg key to build the full path
	 *                to the exported directory and then return the return value from calling the method
	 *                EbayEnterprise_Eb2cCore_Model_Feed_Export_Ack::_extractAckExportedFile which will return an array
	...
	public function testExtractExportedFile()
	{
		...
		$map = array(
			EbayEnterprise_Eb2cCore_Model_Feed_Export_Ack::ACK_KEY => $ackFile,
			EbayEnterprise_Eb2cCore_Model_Feed_Export_Ack::RELATED_KEY => $exportedDir . DS . $exportedFile
		);
		$ackMock = $this->getModelMockBuilder('eb2ccore/feed_export_ack')
			->disableOriginalConstructor()
		...
		$ackMock->expects($this->once())
			->method('_buildPath')
			->with($this->identicalTo(EbayEnterprise_Eb2cCore_Model_Feed_Export_Ack::CFG_EXPORTED_FEED_DIR))
	 ...
	 * Expectation 1: this test will invoked the method EbayEnterprise_Eb2cCore_Model_Feed_Export_Ack::_extractAckExportedFile
	...
	public function testExtractAckExportedFile()
	{
		...
		$xpathMock->expects($this->once())
			->method('query')
			->with(
				$this->identicalTo(EbayEnterprise_Eb2cCore_Model_Feed_Export_Ack::XPATH_ACK_EXPORTED_FILE),
	 ...
	 * Expectation 1: this test will invoked the EbayEnterprise_Eb2cCore_Model_Feed_Export_Ack::_getAck
	 ...
	 * Expectation 1: the method EbayEnterprise_Eb2cCore_Model_Feed_Export_Ack::_mvTo
	 *                invoked by this test and given exported file and will move the file and return self
	 * Expectation 2: the class property EbayEnterprise_Eb2cCore_Model_Feed_Export_Ack::_config has been set to a
	 ...
	 *      throw a EbayEnterprise_Eb2cCore_Exception_Feed_File exception
	 */
	public function testMvToMoveFileThrowException()
	{
		...
		$helperMock->expects($this->once())
			->method('moveFile')
			->with($this->identicalTo($sourceFile), $this->identicalTo($destination))
			->will($this->throwException(new EbayEnterprise_Eb2cCore_Exception_Feed_File('simulate move file exception')));
		$this->replaceByMock('helper', 'eb2ccore', $helperMock);
	...
	public function testMvToRemoveFileThrowException()
	{
		...
		$helperMock->expects($this->once())
			->method('removeFile')
			->with($this->identicalTo($sourceFile))
			->will($this->throwException(new EbayEnterprise_Eb2cCore_Exception_Feed_File('simulate remove file exception')));
		$this->replaceByMock('helper', 'eb2ccore', $helperMock);
	 ...
	 * Expectation 1: this test will invoked the method EbayEnterprise_Eb2cCore_Model_Feed_Export_Ack::_buildPath given a
	...
	public function testBuildPath()
	{
		...
		$helperMock->expects($this->once())
			...
			->with($this->identicalTo($cfgValue), $this->identicalTo(EbayEnterprise_Eb2cCore_Model_Feed_Export_Ack::SCOPE_VAR))
			->will($this->returnValue($absolutePath));
		$this->replaceByMock('helper', 'eb2ccore', $helperMock);
	 ...
	 * Expectation 1: When this test invoked the  EbayEnterprise_Eb2cCore_Model_Feed_Export_Ack::_isResendable
	...
	public function testProcess()
	{
		...
		$ackMock->expects($this->at(3))
			...
			->with(
				...
				$this->identicalTo(EbayEnterprise_Eb2cCore_Model_Feed_Export_Ack::CFG_EXPORT_ARCHIVE)
			)
			->will($this->returnSelf());
		$ackMock->expects($this->at(4))
			...
			->with(
				...
				$this->identicalTo(EbayEnterprise_Eb2cCore_Model_Feed_Export_Ack::CFG_IMPORT_ARCHIVE)
			)
			->will($this->returnSelf());
	...
	public function testProcessWhenNoAckFileOfExportedFeed()
	{
		...
		$ackMock->expects($this->once())
			...
			->with(
				$this->identicalTo($exportedFiles[0]),
				$this->identicalTo(EbayEnterprise_Eb2cCore_Model_Feed_Export_Ack::CFG_EXPORT_OUTBOX)
			)
			->will($this->returnSelf());
