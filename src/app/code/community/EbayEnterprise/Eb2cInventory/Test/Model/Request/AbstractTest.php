...
class EbayEnterprise_Eb2cInventory_Test_Model_Request_AbstractTest extends EbayEnterprise_Eb2cCore_Test_Base
{
	/**
	...
	public function testMakeRequestForQuote($requestType, $operationKey, $xsdConfigKey, $requestSuccess)
	{
		...
		$api->expects($this->once())
			...
			->with($this->identicalTo(EbayEnterprise_Eb2cInventory_Model_Request_Abstract::STATUS_HANDLER_CONFIG_PATH))
