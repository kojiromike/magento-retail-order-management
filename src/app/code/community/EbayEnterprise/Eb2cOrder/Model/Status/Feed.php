 ...
 */
class EbayEnterprise_Eb2cOrder_Model_Status_Feed extends EbayEnterprise_Eb2cCore_Model_Feed_Abstract implements EbayEnterprise_Eb2cCore_Model_Feed_Interface
{
	 ...
	 * @param EbayEnterprise_Dom_Document the feed as already in a DOM
	 * @param array $fileDetail not implemented
	 * @return self
	 * @SuppressWarnings(PHPMD.UnusedLocalVariable)
	 */
	public function processDom(EbayEnterprise_Dom_Document $dom, array $fileDetail=null)
	{
	 ...
	 * @param EbayEnterprise_Dom_Element OrderNode Element
	 * @return array
	 */
	function _rollUpOrderDetails($extractor, EbayEnterprise_Dom_Element $orderNode)
	{
