...
class EbayEnterprise_Eb2cOrder_Model_Status_Feed_Extractor
{
	/**
	 ...
	 */
	public function extractStatusType(EbayEnterprise_Dom_Element $anOrderStatusNode)
	{
	 ...
	 * @param EbayEnterprise_Dom_Element orderStatus
	 * @return EbayEnterprise_Dom_Element <Order> node
	 */
	public function extractOrderNode(EbayEnterprise_Dom_Element $anOrderStatusNode)
	{
	 ...
	 * @param EbayEnterprise_Dom_Element <Order> node
	 * @return EbayEnterprise_Dom_Element <OrderHeader> node
	 */
	public function extractOrderHeaderNode(EbayEnterprise_Dom_Element $anOrderNode)
	{
	 ...
	 */
	public function extractExternalOrderNumber(EbayEnterprise_Dom_Element $anOrderHeaderNode)
	{
	 ...
	 * @param EbayEnterprise_Dom_Element <Order> node.
	 * @return EbayEnterprise_Dom_Element <Shipments> node
	 */
	public function extractShipmentsNode(EbayEnterprise_Dom_Element $anOrderNode)
	{
	 ...
	 * @param EbayEnterprise_Dom_Element <Shipments> node.
	 * @return EbayEnterprise_Dom_Element <Shipment> node
	 */
	public function extractShipmentNode(EbayEnterprise_Dom_Element $aShipmentsNode)
	{
	 ...
	 * @param EbayEnterprise_Dom_Element <Shipment> node.
	 * @return string ShipmentId node value
	 */
	public function extractShipmentId(EbayEnterprise_Dom_Element $aShipmentNode)
	{
	 ...
	 * @param EbayEnterprise_Dom_Element <Shipment> node.
	 * @return EbayEnterprise_Dom_Element <OrderItems> node
	 */
	public function extractOrderItemsNode(EbayEnterprise_Dom_Element $aShipmentNode)
	{
	 ...
	 * @param EbayEnterprise_Dom_Element <OrderItems> node.
	 * @return EbayEnterprise_Dom_Element <OrderItem> node
	 */
	public function extractOrderItemNode(EbayEnterprise_Dom_Element $anOrderItemsNode)
	{
	 ...
	 * @param EbayEnterprise_Dom_Element <OrderItem> node
	 * @return Varien_Object
	 */
	public function orderItemNodeToObject(EbayEnterprise_Dom_Element $anOrderItemNode)
	{
