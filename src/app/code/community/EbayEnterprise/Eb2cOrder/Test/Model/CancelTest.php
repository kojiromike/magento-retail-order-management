 ...
 */
class EbayEnterprise_Eb2cOrder_Test_Model_CancelTest extends EbayEnterprise_Eb2cCore_Test_Base
{
	...
	public function testBuildRequest($orderType, $orderId, $reasonCode, $reason)
	{
		...
		$this->assertInstanceOf('EbayEnterprise_Eb2cOrder_Model_Cancel', $request);

		$domRequest = $this->_reflectProperty($request, '_domRequest');

		// let's assert that the instance of the reflected property is an insteand of EbayEnterprise_Dom_Document
		$this->assertInstanceOf('EbayEnterprise_Dom_Document', $domRequest->getValue($request));
	...
	public function testSendRequest()
	{
		...
		$this->assertInstanceOf('EbayEnterprise_Eb2cOrder_Model_Cancel', $domReponse);

		$domResponse = $this->_reflectProperty($domReponse, '_domResponse');

		// let's assert that the instance of the reflected property is an insteand of EbayEnterprise_Dom_Document
		$this->assertInstanceOf('EbayEnterprise_Dom_Document', $domResponse->getValue($domReponse));
	...
	public function testProcessResponse()
	{
		...
		// assert that sendRequest method return itself
		$this->assertInstanceOf('EbayEnterprise_Eb2cOrder_Model_Cancel', $response);
	}
