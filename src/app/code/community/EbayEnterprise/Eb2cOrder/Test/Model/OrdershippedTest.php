...
class EbayEnterprise_Eb2cOrder_Test_Model_OrdershippedTest extends EbayEnterprise_Eb2cCore_Test_Base
{
	...
	protected $_payload;
	/** @var EbayEnterprise_Eb2cOrder_Model_Ordershipped $_ordershipped */
	protected $_ordershipped;
	/** @var EbayEnterprise_Eb2cOrder_Helper_Event_Shipment $_shipmentHelper */
	...
	/**
	 * This is a procedural test, testing that the method `eb2corder/ordershipped::process`
	...
	/**
	 * Testing the 'eb2corder/ordershipped::_getOrder()' protected method when the order in the payload
	...
	public function testGetOrderMethodOrderInPayloadNotFound()
	{
		...
		$this->assertSame($expectedReturnValue, EcomDev_Utils_Reflection::invokeRestrictedMethod(
			$this->_ordershipped, '_getOrder', []
		));
	}
	/**
	 * Testing the 'eb2corder/ordershipped::_getOrder()' protected method when the order
	 * can not be shipped.
	 */
