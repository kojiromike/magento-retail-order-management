<?php
class EbayEnterprise_Eb2cPayment_Overrides_Model_Observer extends Enterprise_GiftCardAccount_Model_Observer
{
	/**
	...
	/**
	 * overriding this method to ensure the proper website id is set in the giftcardaccount model
	 *
