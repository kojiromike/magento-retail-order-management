<?php
class EbayEnterprise_Eb2cPayment_Test_Block_Overrides_Adminhtml_System_Config_FormTest
	extends EbayEnterprise_Eb2cCore_Test_Base
{
	...
	public function testCanShowFieldUnsuppressed()
	{
		...
		$this->assertInstanceOf(
			'EbayEnterprise_Eb2cPayment_Overrides_Block_Adminhtml_System_Config_Form',
			$testModel,
			'message'
		);
