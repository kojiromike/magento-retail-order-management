...
include(Mage::getBaseDir('app') . DS . 'code/community/EbayEnterprise/Eb2cPayment/controllers/Overrides/GiftCardAccount/CartController.php');
class EbayEnterprise_Eb2cPayment_Test_Controller_Overrides_GiftCardAccount_CartControllerTest extends EcomDev_PHPUnit_Test_Case_Controller
{
	...
	/**
	 * replacing by mock of the EbayEnterprise_Eb2cPayment_Overrides_Model_Giftcardaccount class
	 *
	 * @return void
	 */
	...
	{
		$cartController = new EbayEnterprise_Eb2cPayment_Overrides_GiftCardAccount_CartController(
			$this->mockRequest(),
			$this->mockResponse(),
			array()
		);
