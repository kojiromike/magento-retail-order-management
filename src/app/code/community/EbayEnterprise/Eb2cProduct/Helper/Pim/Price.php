<?php
class EbayEnterprise_Eb2cProduct_Helper_Pim_Price
{
	/**
	...
	{
		return Mage::helper('eb2cproduct/pim')->createStringNode($this->_buildEventNumber($product), $doc);
	}
		...
		EbayEnterprise_Dom_Document $doc)
	{
		...
		return Mage::helper('eb2cproduct/pim')->createTextNode(Mage::getModel('core/store')->roundPrice($price), $doc);
	}
	...
	public function passMsrp(
		...
		EbayEnterprise_Dom_Document $doc)
	{
		return Mage::helper('eb2cproduct/pim')->createTextNode(
			Mage::getModel('core/store')->roundPrice((float) $product->getMsrp()), $doc
		);
	}
		...
		EbayEnterprise_Dom_Document $doc)
	{
		...
		return Mage::helper('eb2cproduct/pim')->createTextNode($altPrice, $doc);
	}
	...
	public function passPriceDateFrom(
		...
		EbayEnterprise_Dom_Document $doc)
	{
		$pim = Mage::helper('eb2cproduct/pim');
	...
	{
		return Mage::helper('eb2cproduct/pim')->createTextNode(
			Mage::helper('eb2ctax')->getVatInclusivePricingFlag()? 'true' : 'false', $doc
		);
	}
