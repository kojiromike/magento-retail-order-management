 ...
 *   Example: EbayEnterprise_Eb2cProduct_Model_Error_Confirmations::loadFile('ItemMaster_20140107224605_12345_ABCD.xml');
 * Step 2: initialize primary data such as the xml directive, root node
 *   and message header
 *   Example: EbayEnterprise_Eb2cProduct_Model_Error_Confirmations::initFeed('ItemMaster');
 ...
 *   Example: EbayEnterprise_Eb2cProduct_Model_Error_Confirmations::addMessage(
 *     self::DOM_LOAD_ERR,
 *     'Dom exception throw while processing feed file'
 *   );
 *   EbayEnterprise_Eb2cProduct_Model_Error_Confirmations::addError(
 *     'ItemMaster',
 *     'ItemMaster_TestSubset.xml'
 *   );
 *   EbayEnterprise_Eb2cProduct_Model_Error_Confirmations::addErrorConfirmation(
 *     'SK-ABC-1334'
 *   );
 *   EbayEnterprise_Eb2cProduct_Model_Error_Confirmations::flush();
 *   Result:
 ...
 *   Example: EbayEnterprise_Eb2cProduct_Model_Error_Confirmations::close();
 *
 ...
 *   Example: EbayEnterprise_Eb2cProduct_Model_Error_Confirmations::process();
 ...
 *   archive folder.
 */
class EbayEnterprise_Eb2cProduct_Model_Error_Confirmations
{
	 ...
	 * @return self
	 * @throws EbayEnterprise_Eb2cProduct_Model_Error_Exception
	 */
	public function append($content='')
	{
		if (is_null($this->_fileStream)) {
			throw new EbayEnterprise_Eb2cProduct_Model_Error_Exception(sprintf(
	...
	public function process(Varien_Event_Observer $observer)
	{
		...
		$coreFeed = Mage::getModel(
			'eb2ccore/feed',
			array('feed_config' => Mage::helper('eb2ccore')->getConfigModel()->errorFeed)
		);
