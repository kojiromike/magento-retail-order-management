...
class EbayEnterprise_Eb2cProduct_Test_Helper_DataTest
	extends EbayEnterprise_Eb2cCore_Test_Base
{
	 ...
	 * dependence.
	 * @expectedException EbayEnterprise_Eb2cProduct_Model_Config_Exception
	 */
	...
	public function testIsValidIsoCountryCode()
	{
		...
		$this->assertSame(true, Mage::helper('eb2cproduct')->isValidIsoCountryCode($countryCode));
	}
}
