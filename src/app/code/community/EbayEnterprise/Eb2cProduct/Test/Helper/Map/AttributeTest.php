...
class EbayEnterprise_Eb2cProduct_Test_Helper_Map_AttributeTest
	extends EbayEnterprise_Eb2cCore_Test_Base
{
	/**
	 * Test _getEntityTypeId method with the following expectations
	 * Expectation 1: when this test invoked this method EbayEnterprise_Eb2cProduct_Helper_Attribute::_getEntityTypeId
	 *                will set the class property EbayEnterprise_Eb2cProduct_Helper_Attribute::_entityTypeId with a
	 ...
	 * Expectation 1: the class property EbayEnterprise_Eb2cProduct_Helper_Attribute::_attributeCollection
	 *                will be set to a known value of null, so that when this test invoked the method
	 *                EbayEnterprise_Eb2cProduct_Helper_Attribute::_getAttributeCollection the mocked
	 ...
	 * Expectation 1: when the method EbayEnterprise_Eb2cProduct_Helper_Attribute::getAttributeIdByName get invoked
	 *                by this test it will be give an attribute code name and it will called the mocked method
	 *                EbayEnterprise_Eb2cProduct_Helper_Attribute::_getAttributeCollection which will return a
	 ...
	 *                EbayEnterprise_Eb2cProduct_Helper_Map_Attribute::_getAttributeOptionId it will
	 ...
	 * Expectation 1: this method EbayEnterprise_Eb2cProduct_Helper_Map_Attribute::extractConfigurableAttributesData
	 ...
	 * Expectation 1: the method EbayEnterprise_Eb2cProduct_Helper_Map_Attribute::_getConfiguredAttributeData with a
	 *                given attribute code will invoked the mocked method EbayEnterprise_Eb2cProduct_Helper_Map_Attribute::_getAttributeInstanceByName
	 ...
	 * Expectation 1: this test will inokved the method EbayEnterprise_Eb2cProduct_Helper_Map_Attribute::_getConfigurableAttributeModel
	 ...
	 * Expectation 1: when this test invoked the method EbayEnterprise_Eb2cProduct_Helper_Map_Attribute::extractCanSaveConfigurableAttributes
	 ...
	 * Expectation 1: the method EbayEnterprise_Eb2cProduct_Helper_Map_Attribute::_getAttributeInstanceByName when invoked
	 ...
	 * Expectation 1: when this test invoked the method EbayEnterprise_Eb2cProduct_Helper_Map_Attribute::isSuperAttributeExists
