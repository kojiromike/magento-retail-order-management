<?php
class EbayEnterprise_Eb2cProduct_Test_Helper_Map_GiftcardTest
	extends EbayEnterprise_Eb2cCore_Test_Base
{
	/**
	 * Test _getGiftCardMap method with the following expectations
	 * Expectation 1: when this test invoked this method EbayEnterprise_Eb2cProduct_Helper_Map_Giftcard::_getGiftCardMap
	 *                will set the class property EbayEnterprise_Eb2cProduct_Helper_Map_Giftcard::_giftcardMap with an
	 ...
	 * Expectation 1: when this test invoked the method EbayEnterprise_Eb2cProduct_Helper_Map_Giftcard::_getGiftCardType
	...
	public function testGetGiftCardType()
	{
		$testData = array(
			array(
				...
				'type' => EbayEnterprise_Eb2cProduct_Helper_Map_Giftcard::GIFTCARD_VIRTUAL
			),
			array(
				'expect' => Enterprise_GiftCard_Model_Giftcard::TYPE_PHYSICAL,
				'type' => EbayEnterprise_Eb2cProduct_Helper_Map_Giftcard::GIFTCARD_PHYSICAL
			),
			array(
				'expect' => Enterprise_GiftCard_Model_Giftcard::TYPE_COMBINED,
				'type' => EbayEnterprise_Eb2cProduct_Helper_Map_Giftcard::GIFTCARD_COMBINED
			),
		);
		$giftcard = Mage::helper('eb2cproduct/map_giftcard');
	 ...
	 *      EbayEnterprise_Eb2cProduct_Helper_Map_Giftcard::extractGiftcardTenderTypeValue and expect
	 ...
	 * Expectation 1: when the EbayEnterprise_Eb2cProduct_Helper_Map_Giftcard::extractIsRedeemable method invoked
	 *                with the given DOMNodeList it will call the EbayEnterprise_Eb2cProduct_Helper_Map_Giftcard::extractGiftcardTenderValue
	 ...
	 * Expectation 1: when the EbayEnterprise_Eb2cProduct_Helper_Map_Giftcard::extractLifetime method invoked
	 *                with the given DOMNodeList it will call the EbayEnterprise_Eb2cProduct_Helper_Map_Giftcard::extractGiftcardTenderValue
	 ...
	 * Expectation 1: the method EbayEnterprise_Eb2cProduct_Helper_Map_Giftcard::extractEmailTemplate when invoked by this test
	 *                will be given a DOMNodeList object and a Mage_Catalog_Model_Product object and with this
	 *                given parameter it will call the EbayEnterprise_Eb2cProduct_Helper_Map_Giftcard::extractGiftcardTenderValue
	 ...
	 *      EbayEnterprise_Eb2cProduct_Helper_Map_Giftcard::extractGiftcardTenderValue return null
