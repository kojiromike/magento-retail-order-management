...
class EbayEnterprise_Eb2cProduct_Test_Helper_Map_StockTest
	extends EbayEnterprise_Eb2cCore_Test_Base
{
	/**
	 * Test EbayEnterprise_Eb2cProduct_Helper_Map_Stock::_getStockMap method with the following expectations
	 * Expectation 1: when this test invoked this method EbayEnterprise_Eb2cProduct_Helper_Map_Stock::_getStockMap
	 *                will set the class property EbayEnterprise_Eb2cProduct_Helper_Map_Stock::_StockMap with an
	...
	/**
	 * Test EbayEnterprise_Eb2cProduct_Helper_Map_Stock::extractStockData method for the following expectations
	 * Expectation 1: when this test invoked the method EbayEnterprise_Eb2cProduct_Helper_Map_Stock::extractStockData with
	 *                a DOMNodeList object it will extract the SalesClass value
	 *                and then call the mocked method EbayEnterprise_Eb2cProduct_Helper_Map_Stock::_getStockMap method
	 *                which will return an array of keys which is all possible sale class value map to actual magento manage_stock value
	 *                then then method EbayEnterprise_Eb2cProduct_Helper_Data::parseBool will be call given the salesclass value
	 */
	...
	/**
	 * Test EbayEnterprise_Eb2cProduct_Helper_Map_Stock::_boolToInt method with the following expectations
	 * Expectation 1: This test will invoked the method EbayEnterprise_Eb2cProduct_Helper_Map_Stock::_boolToInt given
