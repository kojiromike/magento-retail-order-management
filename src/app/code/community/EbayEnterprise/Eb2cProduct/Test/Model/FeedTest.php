...
class EbayEnterprise_Eb2cProduct_Test_Model_FeedTest
	extends EbayEnterprise_Eb2cCore_Test_Base
{
	 ...
	 * Expectation 1: the EbayEnterprise_Eb2cProduct_Model_Feed::_unifiedAllFiles method is expected to be called with the a given
	 *                mocked EbayEnterprise_Eb2cProduct_Model_Feed_Item object as its first parameter, then an array to be merge as its second paraemeter
	 ...
	 * @mock EbayEnterprise_Eb2cProduct_Model_Feed::_unifiedAllFiles
	 * @mock EbayEnterprise_Eb2cProduct_Model_Feed::_compareFeedFiles
	 ...
	 * Expectation 1: the EbayEnterprise_Eb2cProduct_Model_Feed::processFeeds method when invoked by this test
	 *                is expected to call EbayEnterprise_Eb2cProduct_Model_Feed::_getAllFeedFiles which will return an array of
	 *                file detail arrays, in which this result will be loop through to the event type via magic by calling
	 *                EbayEnterprise_Eb2cProduct_Model_Feed::setFeedEventType method, and then calling the processFile method
	 *                and then calling the archiveFeed method
	 * Expectation 2: after the loop the EbayEnterprise_Eb2cProduct_Model_Feed_Cleaner::cleanAllProducts method get call once,
	 ...
	 * Expectation 3: methods EbayEnterprise_Eb2cProduct_Model_Feed_Cleaner::cleanAllProducts, and EbayEnterprise_Eb2cCore_Model_Indexer::reindexAll
	 *                get invoked when the event (product_feed_processing_complete) get dispatch
	 * Expectation 4: these methods EbayEnterprise_Eb2cProduct_Model_Error_Confirmations::loadFile, close, transferFile and archive
	 *                get invoked when the event (product_feed_complete_error_confirmation) get dispatched
	 * @mock EbayEnterprise_Eb2cProduct_Model_Feed::_getAllFeedFiles
	 * @mock EbayEnterprise_Eb2cProduct_Model_Feed::setFeedEventType
	 * @mock EbayEnterprise_Eb2cProduct_Model_Feed::processFile
	 * @mock EbayEnterprise_Eb2cProduct_Model_Feed::archiveFeed
	 * @mock EbayEnterprise_Eb2cProduct_Model_Feed_Cleaner::cleanAllProducts
