	...
	extends EbayEnterprise_Eb2cCore_Test_Base
{
	...
	/**
	 * Test EbayEnterprise_Eb2cProduct_Model_Image_Export::_buildItemImages method for the following expectations
	 * Expectation 1: this test will invoked the method EbayEnterprise_Eb2cProduct_Model_Image_Export::_buildItemImages
	 *                given an EbayEnterprise_Dom_Document object, a store id and an array of image data, then the method
	 *                EbayEnterprise_Eb2cProduct_Model_Image_Export::_buildXmlNodes will be called given the
	 *                EbayEnterprise_Dom_Document object and the array of image data it will then return itself, then
	 *                the method EbayEnterprise_Eb2cProduct_Model_Image_Export::_validateXml will be invoked given the
	 *                EbayEnterprise_Dom_Document object, then the method EbayEnterprise_Eb2cProduct_Model_Image_Export::createFileFromDom
	...
	/**
	 * Test EbayEnterprise_Eb2cProduct_Model_Image_Export::_validateXml method for the following expectations
	 * Expectation 1: this test will invoked the method EbayEnterprise_Eb2cProduct_Model_Image_Export::_validateXml given
	 ...
	 *                EbayEnterprise_Eb2cProduct_Helper_Data::getConfigModel
	 */
	...
	/**
	 * Test EbayEnterprise_Eb2cProduct_Model_Image_Export::_buildXmlNodes method for the following expectations
	 * Expectation 1: this test will invoked the method EbayEnterprise_Eb2cProduct_Model_Image_Export::_buildXmlNodes given
	 ...
	 *                EbayEnterprise_Eb2cProduct_Model_Image_Export::_buildImagesNodes as first parameter and the key
	...
	/**
	 * Test EbayEnterprise_Eb2cProduct_Model_Image_Export::_buildImagesNodes method for the following expectations
	 * Expectation 1: this test will invoked the method EbayEnterprise_Eb2cProduct_Model_Image_Export::_buildImagesNodes
	...
	/**
	 * Test EbayEnterprise_Eb2cProduct_Model_Image_Export::_getImageData method for the following expectations
	 * Expectation 1: this test will invoked the method EbayEnterprise_Eb2cProduct_Model_Image_Export::_getImageData
	 *                given a known store id the method EbayEnterprise_Eb2cProduct_Model_Image_Export::_getProductCollection
	 *                will be invoked given the store id and will return a Mage_Catalog_Model_Resource_Product_Collection object
	 *                which will be loop through each loop cycle will return Mage_Catalog_Model_Product object in which
	 *                the method Mage_Catalog_Model_Product::getSku be call and return a known sku in which the length
	 *                will be compare against the EbayEnterprise_Eb2cProduct_Model_Image_Export::SKU_MAX_LENGTH class
	 *                constant if sku value is less or equal class constant allow the method
	 *                EbayEnterprise_Eb2cProduct_Model_Image_Export::_extractImageData be called given the
	 *                Mage_Catalog_Model_Product object in which return image data
	 */
	...
	/**
	 * Test EbayEnterprise_Eb2cProduct_Model_Image_Export::_extractImageData method for the following expectations
	 * Expectation 1: this test will invoked the method EbayEnterprise_Eb2cProduct_Model_Image_Export::_extractImageData
	 *                given a mocked Mage_Catalog_Model_Product object in which the method
	 *                Mage_Catalog_Model_Product::getMediaGalleryImages will be invoked a return Varien_Data_Collection object
	 *                then the method Varien_Data_Collection::count get call which allowed the method
	 *                Mage_Catalog_Model_Product::getSku to be called and the method
	 *                EbayEnterprise_Eb2cProduct_Model_Image_Export::_getMediaData to be invoked and given
	 *                the Varien_Data_Collection object and the Mage_Catalog_Model_Product object
	 */
	...
	/**
	 * Test EbayEnterprise_Eb2cProduct_Model_Image_Export::_getMediaData method for the following expectations
	 * Expectation 1: this test will invoked the method EbayEnterprise_Eb2cProduct_Model_Image_Export::_getMediaData
	 *                given a Varien_Data_Collection object and a Mage_Catalog_Model_Product object in the method
	 *                EbayEnterprise_Eb2cProduct_Model_Image_Export::_getMageImageViewMap will be invoked given a
	 *                Mage_Catalog_Model_Product object which return an array of image media attribute codes
	 *                given the attribute code to the method EbayEnterprise_Eb2cProduct_Model_Image_Export::_filterImageViews
	 ...
	 *                the method EbayEnterprise_Eb2cProduct_Model_Image_Export::_getImageDimension which return an array
	...
	/**
	 * Test EbayEnterprise_Eb2cProduct_Model_Image_Export::_getProductCollection method for the following expectations
	 * Expectation 1: this test will invoked the method EbayEnterprise_Eb2cProduct_Model_Image_Export::_getProductCollection
	 *                given a store id and expects the following methods to be invoked
	 *                Mage_Catalog_Model_Resource_Product_Collection::addAttributeToSelect, addStoreFilter, and load
	 */
	...
	/**
	 * Test EbayEnterprise_Eb2cProduct_Model_Image_Export::_getMageImageViewMap method for the following expectations
	 * Expectation 1: this test will invoked the method EbayEnterprise_Eb2cProduct_Model_Image_Export::_getMageImageViewMap
	 *                given a mocked Mage_Catalog_Model_Product object and expects the following methods to be invoked
	 *                Mage_Catalog_Model_Product::getAttributes, Mage_Catalog_Model_Resource_Eav_Attribute::getFrontendInput,
	 *                and Mage_Catalog_Model_Product::getData
	 */
	public function testGetMageImageViewMap()
	{
		...
		$attribute->expects($this->once())
			...
			->will($this->returnValue(EbayEnterprise_Eb2cProduct_Model_Image_Export::FRONTEND_INPUT));
	...
	/**
	 * Test EbayEnterprise_Eb2cProduct_Model_Image_Export::_getImageDimension method for the following expectations
	 * Expectation 1: this test will invoked the method EbayEnterprise_Eb2cProduct_Model_Image_Export::_getImageDimension
	...
	/**
	 * Test EbayEnterprise_Eb2cProduct_Model_Image_Export::_filterImageViews method for the following expectations
	 * Expectation 1: this test will invoked the method EbayEnterprise_Eb2cProduct_Model_Image_Export::_filterImageViews
	 *                given an array of image views and expects to return a known array of data
	 */
	public function testFilterImageViews()
	{
		$imageViews = array(
			'image' => EbayEnterprise_Eb2cProduct_Model_Image_Export::FILTER_OUT_VALUE,
			'small_image' => EbayEnterprise_Eb2cProduct_Model_Image_Export::FILTER_OUT_VALUE,
			'thumbnail' => 'selected'
		);
