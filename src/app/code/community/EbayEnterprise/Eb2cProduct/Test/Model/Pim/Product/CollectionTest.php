...
class EbayEnterprise_Eb2cProduct_Test_Model_Pim_Product_CollectionTest
	extends EbayEnterprise_Eb2cCore_Test_Base
{
	...
	{
		$collection = Mage::getModel('eb2cproduct/pim_product_collection');
		$this->setExpectedException('EbayEnterprise_Eb2cProduct_Model_Pim_Product_Collection_Exception', 'EbayEnterprise_Eb2cProduct_Model_Pim_Product_Collection::getFirstItem cannot get item from an empty collection');
	...
	{
		$collection = Mage::getModel('eb2cproduct/pim_product_collection');
		$this->setExpectedException('EbayEnterprise_Eb2cProduct_Model_Pim_Product_Collection_Exception', 'EbayEnterprise_Eb2cProduct_Model_Pim_Product_Collection::getLastItem cannot get item from an empty collection');
	...
	{
		$this->setExpectedException('EbayEnterprise_Eb2cCore_Exception_NotImplemented', 'EbayEnterprise_Eb2cProduct_Model_Pim_Product_Collection::getNewEmptyItem is not implemented');
		$collection = Mage::getModel('eb2cproduct/pim_product_collection');
