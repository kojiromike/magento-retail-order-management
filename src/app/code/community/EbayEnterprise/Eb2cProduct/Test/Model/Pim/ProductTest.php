...
class EbayEnterprise_Eb2cProduct_Test_Model_Pim_ProductTest
	extends EbayEnterprise_Eb2cCore_Test_Base
{
	...
	public function testConstructInvalidArguments()
	{
		$expectedException = sprintf(
			EbayEnterprise_Eb2cProduct_Model_Pim_Product::ERROR_INVALID_ARGS,
			'EbayEnterprise_Eb2cProduct_Model_Pim_Product::_construct',
