...
class EbayEnterprise_Eb2cTax_Model_Request extends Varien_Object
{
	...
	protected function _extractItemData(Mage_Sales_Model_Quote_Item_Abstract $item, Mage_Sales_Model_Quote_Address $address)
	{
		...
		return array_merge(
			array(
				'hts_code' => Mage::helper('ebayenterprise_catalog')->getProductHtsCodeByCountry(
					$mageProduct,
	 ...
	 */
	protected function _buildAddressNode(EbayEnterprise_Dom_Element $parent, $address)
	{
	 ...
	 */
	protected function _buildPersonName(EbayEnterprise_Dom_Element $parent, $address)
	{
	 ...
	 *
	 * @param EbayEnterprise_Dom_Element $parent, the dom element parent node
	 * @param array $adminOrigin, the admin origin address
	 *
	 * @return EbayEnterprise_Dom_Element
	 */
	protected function _buildAdminOriginNode(EbayEnterprise_Dom_Element $parent, array $adminOrigin)
	{
	 ...
	 * @return EbayEnterprise_Dom_Element
	 */
	protected function _buildShippingOriginNode(EbayEnterprise_Dom_Element $parent, array $shippingOrigin)
	{
