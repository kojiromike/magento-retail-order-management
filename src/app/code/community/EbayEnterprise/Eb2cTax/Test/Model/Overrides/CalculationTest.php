 ...
 */
class EbayEnterprise_Eb2cTax_Test_Model_Overrides_CalculationTest extends EbayEnterprise_Eb2cCore_Test_Base
{
	...
	/**
	 * Create a mock of the eb2ctax/response model, scripted with the given
	 * methods. Array of methods should consist of keys mapping to the method
	 * name and values of the mock return value to be given to the mock's `will`
	 * method.
	 * @param  array  $methods Methods to script the mock with
	 * @return Mock_EbayEnterprise_Eb2cTax_Model_Response
	 */
	public function buildResponseMock($methods=null)
	{
		$mock = $this->getModelMockBuilder('eb2ctax/response')
			->disableOriginalConstructor()
			->setMethods(!is_null($methods) ? array_keys($methods) : $methods)
			->getMock();
		foreach ($methods as $method => $mockReturn) {
			$mock->expects($this->any())->method($method)->will($mockReturn);
		}
		return $mock;
	}
	...
	public function testGetTaxShipping()
	{
		...
		$calc->setTaxResponse($this->_mockResponseWithAll());
		$slug = new Varien_Object(array('item' => $this->item, 'address' => $this->addressMock));
		$value = $calc->getTax($slug, EbayEnterprise_Eb2cTax_Overrides_Model_Calculation::SHIPPING_TYPE);
	...
	public function testGetTaxDuty()
	{
		...
		$calc->setTaxResponse($this->_mockResponseWithAll());
		$slug = new Varien_Object(array('item' => $this->item, 'address' => $this->addressMock));
		$value = $calc->getTax($slug, EbayEnterprise_Eb2cTax_Overrides_Model_Calculation::DUTY_TYPE);
	...
	public function testGetTaxForAmount()
	{
		...
		$calc->setTaxResponse($this->_mockResponseWithAll());
		$slug = new Varien_Object(array('item' => $this->item, 'address' => $this->addressMock));
		$value = $calc->getTaxForAmount(1, $slug, EbayEnterprise_Eb2cTax_Overrides_Model_Calculation::MERCHANDISE_TYPE);
		$this->assertSame(0.0625, $value);
		$value = $calc->getTaxForAmount(1.1, $slug, EbayEnterprise_Eb2cTax_Overrides_Model_Calculation::MERCHANDISE_TYPE);
	...
	public function testGetTaxForAmountShipping()
	{
		...
		$calc->setTaxResponse($this->_mockResponseWithAll());
		$slug = new Varien_Object(array('item' => $this->item, 'address' => $this->addressMock));
		$value = $calc->getTaxForAmount(1, $slug, EbayEnterprise_Eb2cTax_Overrides_Model_Calculation::SHIPPING_TYPE);
		$this->assertSame(0.0133, $value);
		$value = $calc->getTaxForAmount(1.1, $slug, EbayEnterprise_Eb2cTax_Overrides_Model_Calculation::SHIPPING_TYPE);
	...
	public function testGetTaxForAmountDuty()
	{
		...
		$calc->setTaxResponse($this->_mockResponseWithAll());
		$slug = new Varien_Object(array('item' => $this->item, 'address' => $this->addressMock));
		$value = $calc->getTaxForAmount(1, $slug, EbayEnterprise_Eb2cTax_Overrides_Model_Calculation::DUTY_TYPE);
		$this->assertSame(8.2362, $value);
		$value = $calc->getTaxForAmount(1.1, $slug, EbayEnterprise_Eb2cTax_Overrides_Model_Calculation::DUTY_TYPE);
	...
	public function testGetDiscountTaxShipping()
	{
		...
		$calc->setTaxResponse($this->_mockResponseWithAll());
		$slug = new Varien_Object(array('item' => $this->item, 'address' => $this->addressMock));
		$value = $calc->getDiscountTax($slug, EbayEnterprise_Eb2cTax_Overrides_Model_Calculation::SHIPPING_TYPE);
	...
	public function testGetDiscountTaxForAmount()
	{
		...
		$calc->setTaxResponse($this->_mockResponseWithAll());
		$slug = new Varien_Object(array('item' => $this->item, 'address' => $this->addressMock));
		$value = $calc->getDiscountTaxForAmount(1, $slug, EbayEnterprise_Eb2cTax_Overrides_Model_Calculation::MERCHANDISE_TYPE);
		$this->assertSame(0.0625, $value);
		$value = $calc->getDiscountTaxForAmount(1.1, $slug, EbayEnterprise_Eb2cTax_Overrides_Model_Calculation::MERCHANDISE_TYPE);
		$this->assertSame(0.06875, $value);
	}
	...
	public function testGetDiscountTaxForAmountShipping()
	{
		...
		$calc->setTaxResponse($this->_mockResponseWithAll());
		$slug = new Varien_Object(array('item' => $this->item, 'address' => $this->addressMock));
		$value = $calc->getDiscountTaxForAmount(1, $slug, EbayEnterprise_Eb2cTax_Overrides_Model_Calculation::SHIPPING_TYPE);
		$this->assertSame(0.0133, $value);
		$value = $calc->getDiscountTaxForAmount(1.1, $slug, EbayEnterprise_Eb2cTax_Overrides_Model_Calculation::SHIPPING_TYPE);
		$this->assertSame(0.01463, $value);
	}
	...
	public function testGetAppliedRates($isAfterDiscounts)
	{
		...
		$testData = array(
			...
			EbayEnterprise_Eb2cTax_Overrides_Model_Calculation::SHIPPING_TYPE,
			EbayEnterprise_Eb2cTax_Overrides_Model_Calculation::DUTY_TYPE, 3
		);
	...
	public function testGetAppliedRatesDuplicateRatesExtraDiscountRates()
	{
		...
		foreach (array(EbayEnterprise_Eb2cTax_Overrides_Model_Calculation::MERCHANDISE_TYPE, 3) as $type) {
			$expectationKey = "{$scenario}-{$type}";
			$e = $this->expected($expectationKey);
			$this->assertArrayHasKey(
				$e->getId(),
