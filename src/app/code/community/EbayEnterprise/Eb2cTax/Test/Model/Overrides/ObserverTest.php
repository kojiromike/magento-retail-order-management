...
class EbayEnterprise_Eb2cTax_Test_Model_Overrides_ObserverTest extends EbayEnterprise_Eb2cCore_Test_Base
{
	 ...
	 * @param  Mock_EbayEnterprise_Eb2cTax_Model_Response $response The response object stored in the session.
	 ...
	 * @param  Mock_EbayEnterprise_Eb2cTax_Model_Response $response Mock response object for the calculation model to return
	 * @return Mock_EbayEnterprise_Eb2cTax_Overrides_Model_Tax_Calculation
	 */
	 ...
	 * @param  Mock_EbayEnterprise_Eb2cTax_Overrides_Model_Calculation $calculator Mock calculation model
	 * @return Mock_EbayEnterprise_Eb2cTax_Overrides_Helper_Data
	 */
