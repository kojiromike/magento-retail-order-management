...
$connection->addForeignKey(
	$installer->getFkName(
		'sales/order_address', 'gift_message_id', 'giftmessage/message', 'gift_message_id'
	),
...
if ($connection->isTableExists('enterprise_giftwrapping/wrapping')) {
	$connection->addForeignKey(
		$installer->getFkName(
			'sales/order_address', 'gw_id', 'enterprise_giftwrapping/wrapping', 'wrapping_id'
		),
		$salesOrderAddressTable,
		'gw_id',
...
$connection->addForeignKey(
	$installer->getFkName(
		'sales/order_item', 'order_address_id', 'sales/order_address', 'entity_id'
	),
