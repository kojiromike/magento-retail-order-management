...
class EbayEnterprise_Order_Model_Orderrejected
{
	...
	protected $_payload;
	/** @var EbayEnterprise_Order_Helper_Event $_orderEventHelper */
	 ...
	 *                          - 'orderEventHelper' => EbayEnterprise_Order_Helper_Event
	...
	protected function _checkTypes(
		...
		return [$payload, $orderEventHelper, $logger, $context];
	}
	/**
