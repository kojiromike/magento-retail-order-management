...
class EbayEnterprise_Order_Test_Helper_Overrides_SalesTest extends EbayEnterprise_Eb2cCore_Test_Base
{
    ...
    {
        $this->assertInstanceOf('EbayEnterprise_Order_Overrides_Helper_Sales', Mage::helper('sales'));
    }
    ...
    {
        $config = Mage::helper('ebayenterprise_order')->getConfigModel();
    ...
    public function testEmailSuppressionOff($testModel, $testMethod)
    {
        ...
        $testModel->expects($this->once())
            ...
            ->will($this->throwException(
                Mage::exception('Mage_Core', 'this exception is expected')
            ));
