...
class EbayEnterprise_Order_Test_Model_OrderrejectedTest extends EbayEnterprise_Eb2cCore_Test_Base
{
    ...
    protected $_payload;
    /** @var EbayEnterprise_Order_Model_Orderrejected $_orderrejected */
    protected $_orderrejected;
    /** @var EbayEnterprise_Order_Helper_Event $_eventHelper */
    ...
    public function setUp()
    {
        ...
        $this->_orderrejected = Mage::getModel('ebayenterprise_order/orderrejected', [
