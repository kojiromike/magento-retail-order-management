...
class EbayEnterprise_Order_Test_Model_Search_Process_Response_CollectionTest extends EbayEnterprise_Eb2cCore_Test_Base
{
    /**
    ...
    public function testSortOrdersMostRecentFirst($orderDateA, $orderDateB, $result)
    {
        ...
        $this->assertSame($result, EcomDev_Utils_Reflection::invokeRestrictedMethod(
            $collection,
            '_sortOrdersMostRecentFirst',
            [$varienObjectA, $varienObjectB]
        ));
    }
}
