<?php
class EbayEnterprise_Eb2cAddress_Test_Block_SuggestionsTest extends EcomDev_PHPUnit_Test_Case
{
	/**
	 * Get an instance of the suggestions block to run some tests against.
	 * @return EbayEnterprise_Eb2cAddress_Block_Suggestions
	 */
	...
	{
		$this->assertSame(
			EbayEnterprise_Eb2cAddress_Block_Suggestions::SUGGESTION_INPUT_NAME,
	...
	{
		$this->assertSame(
			EbayEnterprise_Eb2cAddress_Block_Suggestions::NEW_ADDRESS_SELECTION_VALUE,
