<?php
class EbayEnterprise_Eb2cAddress_Test_Model_Validation_ResponseTest
	extends EcomDev_PHPUnit_Test_Case
{
	...
	public function testIsValidLogged($valid, $message, $logMessage)
	{
		...
		$mockLog->expects($this->once())
			->method('logWarn')
			->with($this->identicalTo($logMessage), $this->contains('EbayEnterprise_Eb2cAddress_Model_Validation_Response'))
