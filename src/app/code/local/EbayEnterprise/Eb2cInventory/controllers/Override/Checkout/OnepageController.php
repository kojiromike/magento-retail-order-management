...
class EbayEnterprise_Eb2cInventory_Override_Checkout_OnepageController extends Mage_Checkout_OnepageController
{
	const EBAY_ENTERPRISE_EB2CINVENTORY_TERMS_AGREEMENT_ERROR = 'EbayEnterprise_Eb2cInventory_Terms_Agreement_Error';
	const EBAY_ENTERPRISE_EB2CINVENTORY_ERROR_PROCESSING_ORDER = 'EbayEnterprise_Eb2cInventory_Error_Processing_Order';
		...
		try {
			...
			if ($requiredAgreements) {
				...
				if ($diff) {
					...
					$result['error'] = true;
					$result['error_messages'] = $this->__(self::EBAY_ENTERPRISE_EB2CINVENTORY_TERMS_AGREEMENT_ERROR);
			...
			$result['success']  = false;
			$result['error']    = true;
			$result['error_messages'] = $this->__(self::EBAY_ENTERPRISE_EB2CINVENTORY_ERROR_PROCESSING_ORDER);
		}
