 ...
 * @codeCoverageIgnore
 */
class EbayEnterprise_Eb2cProduct_Test_Mock_Helper_Data extends EcomDev_PHPUnit_Test_Case
{
	/**
	 * return a mock of the EbayEnterprise_Eb2cCore_Model_Config_Registry class
	 * @return Mock_EbayEnterprise_Eb2cCore_Model_Config_Registry
	 */
	...
	/**
	 * return a mock of the EbayEnterprise_Eb2cProduct_Helper_Data class
	 *
	 * @return Mock_EbayEnterprise_Eb2cProduct_Helper_Data
	 */
	...
	public function replaceByMockFileTransferHelperThrowConnectionException()
	{
		...
		$filetransferHelperMock->expects($this->any())
			->method('getAllFiles')
			->will($this->throwException(new EbayEnterprise_FileTransfer_Exception_Connection));
	...
	public function replaceByMockFileTransferHelperThrowAuthenticationException()
	{
		...
		$filetransferHelperMock->expects($this->any())
			->method('getAllFiles')
			->will($this->throwException(new EbayEnterprise_FileTransfer_Exception_Authentication));
	...
	public function replaceByMockFileTransferHelperThrowTransferException()
	{
		...
		$filetransferHelperMock->expects($this->any())
			->method('getAllFiles')
			->will($this->throwException(new EbayEnterprise_FileTransfer_Exception_Transfer));
