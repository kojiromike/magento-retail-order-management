...
class EbayEnterprise_Eb2cTax_Model_Response_Orderitem extends Varien_Object
{
	...
	{
		$type = EbayEnterprise_Eb2cTax_Model_Response_Quote::MERCHANDISE;
		...
		$type = EbayEnterprise_Eb2cTax_Model_Response_Quote::SHIPPING;
		...
		$type = EbayEnterprise_Eb2cTax_Model_Response_Quote::DUTY;
