...
class EbayEnterprise_Eb2cTax_Test_Model_RequestTest extends EbayEnterprise_Eb2cCore_Test_Base
{
	...
	{
		$fn      = $this->_reflectMethod('EbayEnterprise_Eb2cTax_Model_Request', '_addToDestination');
		$d       = $this->_reflectProperty('EbayEnterprise_Eb2cTax_Model_Request', '_destinations');
