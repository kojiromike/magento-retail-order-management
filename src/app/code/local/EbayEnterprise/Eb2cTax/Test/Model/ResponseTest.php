 ...
 */
class EbayEnterprise_Eb2cTax_Test_Model_ResponseTest extends EbayEnterprise_Eb2cCore_Test_Base
{
	...
	{
		self::$cls = new ReflectionClass('EbayEnterprise_Eb2cTax_Model_Response');
...
XML;
	 ...
	 * @param  string $xml
	 * @param  bool $isValid
	 * @return EbayEnterprise_Eb2cTax_Model_Request
	 */
