...
/**
 * This class is mainly just here for typechecking the data stored in the
 * session for address validation.
 ...
 * @method Mage_Customer_Model_Address_Abstract[] getSuggestedAddresses()
