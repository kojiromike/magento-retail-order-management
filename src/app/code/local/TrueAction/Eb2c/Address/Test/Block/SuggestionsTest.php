...
class TrueAction_Eb2c_Address_Test_Block_SuggestionsTest
	extends EcomDev_PHPUnit_Test_Case
{

	/**
	 * Get an instance of the suggestions block to run some tests against.
	 * @return TrueAction_Eb2c_Address_Block_Suggestions
	 */
	...
	{
		$this->assertSame(
			TrueAction_Eb2c_Address_Block_Suggestions::SUGGESTION_INPUT_NAME,
	...
	{
		$this->assertSame(
			TrueAction_Eb2c_Address_Block_Suggestions::NEW_ADDRESS_SELECTION_VALUE,
