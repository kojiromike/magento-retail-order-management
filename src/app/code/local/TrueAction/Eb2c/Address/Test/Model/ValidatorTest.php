	...
	extends EcomDev_PHPUnit_Test_Case
{
	...
	public function testValidateAddressMultiSuggestions()
	{
		...
		$this->assertSame(
			TrueAction_Eb2c_Address_Model_Validator::SUGGESTIONS_ERROR_MESSAGE,
			$errorMessage,
	...
	public function testWithValidatedAddress()
	{
		...
		$this->assertInstanceOf('TrueAction_Eb2c_Address_Model_Suggestion_Group', $session->getData(TrueAction_Eb2c_Address_Model_Validator::SESSION_KEY));
	}
	...
	public function testSessionInteractionsNoValidationNecessary($useForShipping)
	{
		...
		// properly set
		$session = $this->_getSession();
		$group = $session->getData(TrueAction_Eb2c_Address_Model_Validator::SESSION_KEY);
