<?php
/**
 * Mage_Sales_Quote_Address_Item extended for Eb2c.
 *
 */
class TrueAction_Eb2c_Core_Model_Quote_Address_Item extends Mage_Sales_Model_Quote_Address_Item implements TrueAction_Eb2c_Core_Model_Item_Interface
{
	/**
