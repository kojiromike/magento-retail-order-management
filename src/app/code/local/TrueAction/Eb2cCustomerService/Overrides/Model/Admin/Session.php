...
class TrueAction_Eb2cCustomerService_Overrides_Model_Admin_Session
	extends Mage_Admin_Model_Session
{
	...
	public function loginCSRWithToken($token, Mage_Core_Controller_Request_Http $request=null)
	{
		...
		} catch (TrueAction_Eb2cCustomerService_Exception_Authentication $e) {
	 ...
	 * @return self
	 * @throws TrueAction_Eb2cCustomerService_Exception_Authentication if the user is invalid
	 */
	protected function _validateUser(Mage_Admin_Model_User $user)
	{
		if (!$user->getIsActive()) {
			throw new TrueAction_Eb2cCustomerService_Exception_Authentication(
