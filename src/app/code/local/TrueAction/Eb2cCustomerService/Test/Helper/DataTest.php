...
class TrueAction_Eb2cCustomerService_Test_Helper_DataTest
	extends TrueAction_Eb2cCore_Test_Base
{
	...
	public function testGetConfig()
	{
		...
		$cfg->expects($this->once())
			...
			->with($this->isInstanceOf('TrueAction_Eb2cCustomerService_Model_Config'))
	...
	public function testValidateTokenPass()
	{
		...
		$this->assertInstanceOf(
			'TrueAction_Eb2cCustomerService_Model_Representative',
	...
	public function testValidateTokenFail($isCsrEnabled)
	{
		...
		$this->setExpectedException(
			'TrueAction_Eb2cCustomerService_Exception_Authentication',
