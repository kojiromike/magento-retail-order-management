...
class TrueAction_Eb2cCustomerService_Test_Model_Overrides_Admin_SessionTest
	extends TrueAction_Eb2cCore_Test_Base
{
	...
	public function testValidateUser($isActive, $hasAssignedToRole)
	{
		...
		if (!($isActive && $hasAssignedToRole)) {
			$this->setExpectedException('TrueAction_Eb2cCustomerService_Exception_Authentication');
		}
		$session = $this->getModelMockBuilder('admin/session')
			->disableOriginalConstructor()
			->setMethods(null)
