...
class TrueAction_Eb2cInventory_Test_Mock_Helper_Data extends EcomDev_PHPUnit_Test_Case
{
	...
	/**
	 * return a mock of the TrueAction_Eb2cInventory_Helper_Constants class
	 *
	 * @return Mock_TrueAction_Eb2cInventory_Helper_Constants
	 */
	public function buildEb2cInventoryConstant()
	{
		return new TrueAction_Eb2cInventory_Helper_Constants();
	}
	...
	public function buildEb2cInventoryHelper()
	{
		$helperMock = $this->getMock(
			'StdClass',
			array(
				'__construct', 'getCoreHelper', 'getFileTransferHelper', 'getConfigModel', 'getConstantHelper',
		...
		$helperMock->expects($this->any())
			...
			->will($this->returnValue(new TrueAction_Eb2cInventory_Helper_Constants()));
		$helperMock->expects($this->any())
			->method('getCoreFeed')
