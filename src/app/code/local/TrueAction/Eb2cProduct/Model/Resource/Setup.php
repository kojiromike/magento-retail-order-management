...
class TrueAction_Eb2cProduct_Model_Resource_Setup extends Mage_Core_Model_Resource_Setup
{
	 ...
	 * @return int
	 */
	public function _getDefaultEntityTypeId()
	{
	 ...
	 */
	protected function _loadDefaulltAttributesConfig()
	{
	 ...
	 */
	protected function _getDefaultAttributeCodeList()
	{
		...
		return array('tax_code', 'is_drop_shipped', 'drop_ship_supplier_name', 'drop_ship_supplier_number', 'drop_ship_supplier_part', 'price_is_vat_inclusive');
	}
