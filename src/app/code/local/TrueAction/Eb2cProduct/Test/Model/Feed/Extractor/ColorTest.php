	...
	extends TrueAction_Eb2cCore_Test_Base
{
	/**
	 */
	public function testExtractWithLang()
	{
		$xml = '
			<root>
				<foo xml:lang="en_US"><Value>1</Value><Description >desc1</Description></foo>
			</root>';

		$base = array('thefoo' => 'foo');
		$valueAlias = array('code' => 'value/text()', 'lang' => './@xml:lang');
	...
	public function testBadArg1($scenario, $arg1)
	{
		...
		$x = Mage::getModel('eb2cproduct/feed_extractor_valuedesc', array($arg1));
	}
}
