 ...
 */
class TrueAction_Pbridge_Model_Cc extends Mage_Payment_Model_Method_Cc
{
	/**
	 * Payment method code
	 *
	 ...
	 * @var string
	 */
	protected $_formBlockType = 'trueaction_pbridge/checkout_payment_cc';
	 ...
	 * @var string
	 */
	protected $_backendFormBlockType = 'trueaction_pbridge/adminhtml_sales_order_create_cc';
